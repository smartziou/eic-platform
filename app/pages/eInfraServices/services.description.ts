...
export const symbolDesc = {label: "symbol", mandatory: false, desc: "Link to a visual representation for the service. If none exists, providers are urged to use the organization's symbol"};
...
export const providerDesc = {label: "providers", mandatory: true, desc: "Organisation that manages and delivers the service and with whom the customer signs the SLA"};
...
export const tagsDesc = {label: "tags", mandatory: true, desc: "Field to facilitate searching based on keywords"};
export const requiredServicesDesc = {label: "required Services", mandatory: false, desc: "Other services that are either required or commonly used with this service"};
export const relatedServicesDesc = {label: "related Services", mandatory: false, desc: "Other services that are either required or commonly used with this service"};
export const requestDesc = {label: "request", mandatory: true, desc: "Link to request the service from the service providers"};
export const helpdeskDesc = {label: "helpdesk", mandatory: false, desc: "Link with contact to ask more information from the service providers about this service. A contact person or helpdesk within the organization must be assigned for communications, questions and issues relating to the service"};
export const userManualDesc = {label: "user Manual", mandatory: false, desc: "Link to user manual and documentation"};
export const trainingInformationDesc = {label: "Training", mandatory: false, desc: "Link to training information"};
export const feedbackDesc = {label: "feedback", mandatory: false, desc: "Link to page where customers can provide feedback on the service"};
export const priceDesc = {label: "price", mandatory: true, desc: "Supported payment models that apply. List of sentences each of them stating the type of payment model and the restriction that applies to it"};
export const serviceLevelAgreementDesc = {label: "SLA", mandatory: false, desc: "Document containing information about the levels of performance that a service providers is expected to achieve. Current service agreements (SLAs) available for the service or basis for a new SLA. These should be agreements with users (not providers)"};
export const termsOfUseDesc = {label: "terms Of Use", mandatory: false, desc: "Document containing the rules, service conditions and usage policy which one must agree to abide by in order to use the service"};
